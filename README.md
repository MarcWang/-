...
- [Xerces](http://xerces.apache.org/xerces-c/install-3.html#Unix) `Code`
- [OpenSSL](https://www.openssl.org/) `Code`
- [cURL](https://curl.haxx.se/download.html) `Code`
...
### 架構
- [unirest](http://unirest.io/) `HTTP` `Library`

### 開發
- [bugsnag](https://bugsnag.com/) `Workflow`
- [DR.Memory](https://github.com/dynamorio/drmemory) `MemoryDebugger`
- [Valgrind](http://valgrind.org/) `MemoryDebugger`
- [ideone](http://ideone.com/) `Online`
...
- [momentjs](http://momentjs.com/) `Time` `Node`
- [lodash](https://lodash.com/) `Utility` `Node`
- [videojs](http://videojs.com/) `Stream` `Node`
...
- [Docker tutorial](https://linuxmeerkat.wordpress.com/2014/07/21/docker-tutorial/) `Document`
